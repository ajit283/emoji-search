...
const Slider = ({
  ...
  return (
    <div className="flex flex-row items-center gap-5 max-w-[750px] w-full">
      ...
      <div className=" group text-2xl relative rounded-full  p-2 cursor-pointer">
        {/* <QuestionMarkCircleIcon height={20} width={20} /> */}
        ℹ️
        <div className="absolute rounded-lg p-2 mt-8   border-[1px] bg-stone-100 shadow-lg text-xs w-48 z-40 text-center -bottom-32  inset-x-auto left-1/2 transform -translate-x-1/2  group-hover:block hidden transition-all duration-250">
